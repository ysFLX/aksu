    ...
    <main className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
      <section className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
        ...
        <p className="max-w-2xl text-lg leading-8 text-white/68">
          Gorkemoto, arac ilanlarini sadece listeleyen bir galeri degil; musterinin kararini kolaylastiran, detaylari saklamayan
          ve her temasta profesyonellik hissettiren bir marka deneyimi kurmak icin tasarlandi.
        </p>
      </section>
      ...
      <section className="mt-16 grid gap-6 lg:grid-cols-2">
        <article className="rounded-[2rem] border border-white/10 bg-black/25 p-8">
          ...
          <p className="mt-4 text-white/68 leading-8">
            Mutfakta hizli satis degil, dogru eslesme var. Portfoy seciminden musteri iletisime kadar her noktada daha rafine
            bir galeri deneyimi sunmaya odaklaniyoruz.
          </p>
